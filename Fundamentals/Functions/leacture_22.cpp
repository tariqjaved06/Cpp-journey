// Fundtion overload:Function  more than one having same identifier if we change the arguments of these functions pc deal it as different function and also in function tarteeb matters
#include <iostream>
using namespace std;
// funtion for sum
...
int main()
{
    ...
    char p;
    cout << "\n Enter the kind of processing you want to do(+,a,p,M,m):";
    cin >> p;
    switch (p)
    {
    case '+':
